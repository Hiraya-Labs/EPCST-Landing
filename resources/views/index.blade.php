...
{{-- Hero Left --}}
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Eastwoods Professional College
        <br class="hidden lg:inline-block">of Science and Technology
      </h1>
      <p class="mb-8 leading-relaxed">Since its establishment in 1994 by founder Mr. Gregorio M. Sison, Jr., EASTWOODS has been recognized as the only Assessment Center in Balanga City accredited by the Technical Education and Skills Development Authority (TESDA).</p>
      <div class="flex justify-center">
    
      <form action="https://forms.gle/22mTtShNj6MtoVEG7" target="_blank">
        <button class="inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Enroll Now!</button>
      </form>
...
{{-- Hero Right --}}
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      ...
      <img class="object-cover object-center rounded" alt="hero" src="img/epcst-logo.png">
    </div>
  </div>
</section>
...
{{-- Stats 2 --}}
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p class="leading-relaxed">Transferees</p>
        </div>
      </div>
...
{{-- Stats 3 --}}
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p class="leading-relaxed">Returnees</p>
        </div>
      </div>
...
{{-- Stats 4 --}}
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 class="title-font font-medium text-3xl text-gray-900">1.7K</h2>
...
<section id="courses" class="courses text-gray-600 body-font bg-green-50">
  ...
  <div class="text-center mb-20">
      ...
      <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">EASTWOODS PROFESSIONAL COLLEGE OF SCIENCE AND TECHNOLOGY IS NOW ACCEPTING NEW ENROLLEES, RETURNEES AND TRANSFEREES FOR SCHOOL YEAR 2023-2024!</p>
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <h2 class="text-gray-900 title-font text-lg font-medium">Bachelor of Science in Computer Engineering</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CHED</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">Bachelor of Science in Information Technology</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CHED</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">Bachelor of Science in Computer Science</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CHED</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">Bachelor of Science in Hospitality Management</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CHED</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">2 Year Associate in Computer Technology</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <h2 class="text-gray-900 title-font text-lg font-medium">Electronic Products Assembly and Servicing NCII</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">TESDA</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">Caregiving Program</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">TESDA</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium"><span class="text-hirayaRed font-medium">New! </span>3 Year Hotel and Restaurant Technology</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">TESDA</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium"><span class="text-hirayaRed font-medium">New! </span>2 Year Hotel and Restaurant Services</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <h2 class="text-gray-900 title-font text-lg font-medium">Food and Beverage Services NCII</h2>
        </div>
      </div>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Free Training & Assessment</h3>
          <h2 class="text-gray-900 title-font text-lg font-medium">Computer System Services NCII</h2>
        </div>
      </div>
...
<section id="news-and-blogs" class="news-and-blogs text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex w-full mb-20 flex-wrap">
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 lg:w-1/3 lg:mb-0 mb-4">News and Blogs</h1>
      <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">Find the latest Blogs news. See related Eastwoods Professional College of Science and Technology articles, photos, slideshows and videos.</p>
    </div>
...
{{-- Contact Us --}}
<div id="contactUs" class="contactUs text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">We'd love to hear from you!</h1>
      <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Whether you have a inquires about enrollment, courses, subjects or anything else, we are ready to answer all of your inquires.</p>
      <div class="flex mt-6 justify-center">
        <div class="w-16 h-1 rounded-full bg-green-500 inline-flex"></div>
      </div>
</div>
...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3859.5850963101507!2d120.53428347586026!3d14.679471875139239!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396400661380387%3A0xb1dc9bf4064accce!2sEASTWOODS%20Professional%20College%20of%20Science%20%26%20Technology!5e0!3m2!1sfil!2sph!4v1687718219525!5m2!1sfil!2sph" style="filter:contrast(1.2) opacity(0.7;"></iframe>
      <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        <div class="lg:w-1/2 px-6">
          <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
          <p class="mt-1">A.H Banzon St. Ibayo, City of Balanga, Bataan</p>
        </div>
        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
          <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
          <a class="text-green-500 leading-relaxed">
EastwoodsProfessional@yahoo.com</a>
...
(047) 791 2791</p>
    ...
    <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">What is on your mind?</h2>
      <p class="leading-relaxed mb-5 text-gray-600">To send us a message, Please enter your name, email and message in the fields provided then click send.</p>
      ...
      <p class="text-xs text-gray-500 mt-3">Thank you for messaging us!</p>
    </div>
  </div>
</section>
...
<section class="downloadApp text-gray-600 body-font bg-green-500">
  <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
    <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
      <h2 class="text-xs text-white tracking-widest font-medium title-font mb-1">EPCST Portal Mobile App</h2>
      <h1 class="md:text-3xl text-4xl font-medium title-font text-white">Our EPCST Portal is now available for DOWNLOAD!</h1>
    </div>
